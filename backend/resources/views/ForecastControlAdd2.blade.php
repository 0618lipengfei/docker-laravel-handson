...
<html lang="ja">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#apply_button').click( function () {
                ...
                document.add_form.model.value = selected_data[0][0];
            ...
            $('#next').click( function () {
                ...
                var selected_data = table.rows('.selected').data();
                window.location.href = 'http://127.0.0.1:10080/ForecastControl/Add3?target_group=' +  encodeURIComponent(decodeURIComponent(value[1])) + '&model=' +  encodeURIComponent(selected_data[0][0]);
                // alert( selected_data[0][0]+"が選択された。");
            } );
            ...
            //     window.location.href = 'http://127.0.0.1:10080/ForecastControl/Add1?target_group=' +  encodeURIComponent(decodeURIComponent(value[1]));
            //     // alert( selected_data[0][0]+"が選択された。");
            // } );
        ...
        window.onload = function ()
        {
            ...
            var obj = document.getElementById("target_group");
            // obj.placeholder = "test";
            obj.value = decodeURIComponent(value[1]);
        }
    </script>
  ...
  <body>
    ...
    <form id="add_form" name="add_form" method="POST">
      ...
      <div><b>モデル：</b><input id="model" style="width: 20em;" type="text" name="model" readonly="readonly" placeholder="モデルを選択してください"></div>      
      ...
      <div align="right">
          ...
          <!-- <input type="button" style="width: 10em;" id="back" name="back" value="戻る"> -->
