...
<html lang="ja">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#apply_button').click( function () {
                ...
                document.edit_form.model_entity.value = selected_data[0][0];
            ...
            $('#next').click( function () {
                ...
                window.location.href = 'http://127.0.0.1:10080/ForecastControl/Edit4?target_group=' 
  ...
  <body>
    ...
    <form id="edit_form" name="edit_form" method="POST">
      ...
      <div><b>モデルエンティティ：</b><input id="model_entity" style="width: 20em;" type="text" name="model_entity" readonly="readonly"></div>
      ...
      <div align="right">
          ...
          <!-- <input type="button" style="width: 10em;" name="back" value="戻る" onclick="location.href='http://127.0.0.1:10080/ForecastControl/Edit2'"> -->
